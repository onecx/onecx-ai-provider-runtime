...
| quarkus-langchain4j-oidc-client-mcp-auth-provider

| https://quarkus.io/extensions/io.quarkiverse.langchain4j/quarkus-langchain4j-oidc-client-mcp-auth-provider/[Link]
